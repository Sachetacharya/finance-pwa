...
const BACKUP_KEYS = [
  'fp_expenses', 'fp_accounts', 'fp_budgets', 'fp_budget_settings',
  'fp_recurring', 'fp_loans', 'fp_templates',
  'fp_transfer_charge',
  'fp_salary_wizard_config', 'fp_budget_wizard_config',
  'fp_weekly_discretionary',
  'auth_user', 'auth_token', 'fp_theme',
];
